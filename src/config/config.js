...
const userCommands = [
    ...
    },
    {
        ...
        description: '"park AP_12345 White" will allocate the nearest slot from entry gate.'
    },
    {
        type: 'leave',
    ...
    },
    {
        ...
        description: '"slot_number_for_registration_number AP_12345" will display the slot number for the car with registration number MH-04-AY-1111.'
    },
    {
        type: 'leave_car_by_registration_number',
        description: '"leave_car_by_registration_number AP_12345" will free the slot occupied by car with registration number JH-01-LT-0008.'
    },
    {
